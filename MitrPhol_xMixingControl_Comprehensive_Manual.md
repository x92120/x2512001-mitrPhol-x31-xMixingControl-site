...
<div class="cover-title">คู่มือและเอกสารทางเทคนิคฉบับสมบูรณ์ (Comprehensive Technical & Operational Manual)</div>
<div class="cover-subtitle">ระบบควบคุมการผลิต xMixing Control Application</div>

<table class="doc-info">
<tr><th>รหัสเอกสาร (Document No.)</th><td>MAN-SYS-MIX-001</td></tr>
<tr><th>แก้ไขครั้งที่ (Revision)</th><td>01 (Master Compilation)</td></tr>
<tr><th>วันที่บังคับใช้ (Effective Date)</th><td>25 มิถุนายน 2026</td></tr>
<tr><th>หน่วยงาน (Department)</th><td>ฝ่ายวิศวกรรม, ไอที และฝ่ายผลิต</td></tr>
</table>
</div>
